// m_random.mjs -- GENERATED by test/tools/gen_tables.py from
// reference_materials/doom/linuxdoom-1.10/m_random.c -- DO NOT EDIT BY HAND.
//
// Part of tsvm-doom, a derivative of linuxdoom-1.10 (C) id Software.
// Licensed under GPL-2.0-only; see COPYING.
//
// Two independent indices: P_Random drives the playsim (demo-sync
// critical call order), M_Random everything cosmetic.
...
// p_saveg needs the indices; demo start resets them
function getPrndIndex() { return prndindex }
function setPrndIndex(i) { prndindex = i & 0xff }
function getRndIndex() { return rndindex }
function setRndIndex(i) { rndindex = i & 0xff }

exports = {
    rndtable, P_Random, M_Random, M_ClearRandom,
    getPrndIndex, setPrndIndex, getRndIndex, setRndIndex,
    init: function (D) {},
}
